...
// Auth
export const auth = {
  login: (email: string, password: string) => fetchApi('/api/auth/login', {
    method: 'POST',
    body: JSON.stringify({ email, password }),
  }),

  register: (email: string, password: string) => fetchApi('/api/auth/register', {
    method: 'POST',
    body: JSON.stringify({ email, password }),
  }),
...
export const businesses = {
  ...
  update: (id: string, data: any) => fetchApi(`/api/businesses/${id}`, {
    method: 'PUT',
    body: JSON.stringify(data),
  }),
  
  delete: (id: string, userId: string) => fetchApi(`/api/businesses/${id}?userId=${userId}`, {
    method: 'DELETE',
  }),
};
...
export const scraping = {
  create: (data: any) => fetchApi('/api/scraping/jobs', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
...
export const enrichment = {
  create: (data: any) => fetchApi('/api/enrichment/jobs', {
    method: 'POST',
    body: JSON.stringify(data),
  }),
  ...
  getStatus: (jobId: string) => fetchApi(`/api/enrichment/jobs/${jobId}/status`),
};

// Database Operations
export const database = {
  test: (connection: any) => fetchApi('/api/database/test', {
    method: 'POST',
