        ...
        <Router>
          ...
          <Routes>
            ...
            <Route path="/" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
              ...
              {/* Scraping routes */}
              <Route path="scraping">
                <Route index element={<Navigate to="/scraping/new" replace />} />
              ...
              <Route path="enrichment">
                <Route index element={<Navigate to="/enrichment/upload" replace />} />
              ...
              <Route path="email-campaigns">
                ...
                <Route path=":campaignId/analytics" element={<CampaignAnalytics />} />
